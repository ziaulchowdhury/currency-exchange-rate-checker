...
/**
 * Controller for retrieving exchange rates from <a href="https://openexchangerates.org">OpenExchangeRates</a> and 
 * displaying search histories for each user.
 * 
...
public class OpenExchangeCurrencyConverterController extends ControllerCache {
	...
	/**
	 * Retrieves historical exchange rates (specific date given) from <a href="https://openexchangerates.org">
	 * OpenExchangeRates</a>. Retrieved rates are stored as search history for the specific user.
	 * 
	 * @param model UI model
	 * @param historicalRateModel {@link HistoricalRateModel}
	 * @param bindingResult Binding result for validation
	...
	/**
	 * Retrieves top 10 exchange rate search histories of the logged in user and
	 * add to the UI model.
	 * 
	 * @param model UI model
	 */
