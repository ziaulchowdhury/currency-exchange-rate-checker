...
public class OpenExchangeCurrencyConverter {
	...
	/**
	 * Retrieves latest exchange rates from
	 * <a href="https://openexchangerates.org">OpenExchangeRates</a> by using
	 * REST template. Retrieved rates are stored as search history for the
	 * specific user.
	 * 
	 * @param baseCurrency
	 ...
	 *            Amount
	 * @param dateOfRate
	 *            Date for getting the historical exchange rate
	 * 
	 * @return {@link CurrencyRateModel}
	 * 
	 * @throws InvalidParameterException
	 ...
	 * 
	 * @param rates
	 *            Currency rates to be saved
	 * @param baseCurrency
	 *            Base currency which was used in the search
	 * @param amount
	 *            Amount of base currency
	 * @param dateOfRate
	 *            Date when the search was performed
	 * @param userName
	 *            Username of the user who has searched the exchange rate
	 * 
	 * @throws InvalidParameterException
