...
/**
 * Service for retrieving lates and historical currency exchange rates from <a href="https://openexchangerates.org">OpenExchangeRates</a>.
 * 
...
public class OpenExchangeCurrencyConverter {
	...
	/**
	 * Retrieves latest exchange rates from <a href="https://openexchangerates.org">OpenExchangeRates</a>
	 * by using REST template. Retrieved rates are stored as search history for the specific user. 
	 * 
	 ...
	 */
	public CurrencyRateModel getLatestCurrencyRates(String baseCurrency, double amount) throws InvalidParameterException {
		...
		builder.append("https://openexchangerates.org/api/latest.json?app_id=").append(apiKey)
	...
	public CurrencyRateModel getHistoricalCurrencyRates(String baseCurrency, double amount, LocalDate dateOfRate) 
		...
		StringBuilder builder = new StringBuilder();
		builder.append("https://openexchangerates.org/api/historical/")
			.append(dateOfRate.format(formatter))
			.append(".json?app_id=").append(apiKey)
			.append("&base=").append(baseCurrency);
	 ...
	 * @throws InvalidParameterException for invalid arguments
	 */
	private void saveExchangeRate(CurrencyRateModel rates, String baseCurrency, double amount, LocalDate dateOfRate, String userName) 
			throws InvalidParameterException {
